            ...
            <nav className="header__nav">
                ...
                <div className="header__nav__right">
                    ...
                    <div className="header__nav__right__tablet-nav">
                        <ul className="header__nav__right__tablet-nav__list">
                            ...
                            <li className="header__nav__right__tablet-nav__list__item"><Link className="header__nav__right__tablet-nav__list__item-link" to="/personal-website/Resume.pdf" target="_blank">Resume</Link></li>
                        </ul>
                    </div>
                ...
                >
                        ...
                        >
                            ...
                            <motion.li className="header__nav__container__menu__list" variants={links}><Link className="header__nav__container__menu__list-link" to="/personal-website/Resume.pdf" target="_blank">Resume</Link></motion.li>
                        </motion.ul>
                </motion.div>
            </nav>
        </motion.header>

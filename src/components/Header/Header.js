            ...
            <nav className="header__nav">
                ...
                <div className="header__nav__right">
                    ...
                    <div className="header__nav__right__tablet-nav">
                        <ul className="header__nav__right__tablet-nav__list">
                            ...
                            <li className="header__nav__right__tablet-nav__list__item"><a className="header__nav__right__tablet-nav__list__item-link" href="/resume/Resume.pdf" target="_blank">Resume</a></li>
                        </ul>
                    </div>
                ...
                >
                        ...
                        >
                            ...
                            <motion.li className="header__nav__container__menu__list" variants={links}><a href="/resume/Resume.pdf" rel="noopener noreferrer" target="_blank" className="header__nav__container__menu__list-link">Resume</a></motion.li>
                        </motion.ul>
                </motion.div>
            </nav>
        </motion.header>
